function execute() {
    const blackList = [
        ...
        "Người Ai Cập - Quyền Lực Và Tình Yêu 1",
        "Người Ai Cập - Quyền Lực Và Tình Yêu 2",
        "Bên Rặng Tuyết Sơn",
        "Bí Quyết Đơn Giản Hoá Tình Yêu",
        "Bí Mật Của May Mắn",
        "Bài Học Diệu Kỳ Từ Chiếc Xe Rác",
        "Cởi Trói Linh Hồn - Hành Trình Vượt Qua Giới Hạn Của Chính Mình",
        ...
        "Chiến Lược Dữ Liệu",
        "Thu Hút Thế Giới Về Với Bạn Trong Môi Trường Trực Tuyến",
        ...
        "Làm Giàu Từ Suy Nghĩ",
        "Hành Trình Chiến Lược – Kế Hoạch Và Thực Hiện Mỗi Ngày",
